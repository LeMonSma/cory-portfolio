        ...
        <header className="col-1 container">
            ...
            <nav className='mt-5 ml-2'>
                ...
                <ul className='' >
                    ...
                    <li className={`col-md-2 offset-md-2 mt-5 ${selected === 'about' && 'navActive'}`} onClick={navHandler} data-page='about'>
                        <span data-testid="about">
                            <FontAwesomeIcon className='fa-2xl' icon={faHome} />
                        </span>
                    </li>
                    <li className={`col-md-2 offset-md-2 mt-5 ${selected === 'portfolio' && 'navActive'}`} onClick={navHandler} data-page='portfolio'>
                        <span data-testid="portolio">
                            <FontAwesomeIcon className='fa-2xl' icon={faCode} />
                        </span>
                    </li>
                    <li className={`col-md-2 offset-md-2 mt-5 ${selected === 'contact' && 'navActive'}`} onClick={navHandler} data-page='contact'>
                        <span data-testid="contact" href="#about">
                            <FontAwesomeIcon className='fa-2xl' icon={faEnvelope} />
                        </span>
                    </li>
                    <li className='col-md-2 offset-md-2 mt-5'>
